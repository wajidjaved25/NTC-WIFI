#!/bin/bash
# ============================================
# FreeRADIUS Data Limits Setup Script (Fixed)
# ============================================
# 
# Run this script on your Ubuntu RADIUS server to enable data usage limits
# Usage: sudo bash setup_radius_data_limits_fixed.sh
...
# Create sqlcounter configuration (without reply_name to avoid dictionary issues)
...
sqlcounter daily_data_counter {
    ...
    # reply_name removed - not needed for enforcement
